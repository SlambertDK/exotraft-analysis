...
- **Danish design credibility** — premium aesthetic resonates in Nordics and Germany
- **First-mover in smart/connected** — no competitor has built a serious app/connected product
- **Growing market** — heat pump transition, energy prices, air quality regulation all tailwinds
- **Defensible with data** — once 10,000 fans are connected, combustion dataset becomes a moat

## Weaknesses
- **Hardware economics** — capital intensive, margin pressure, supply chain risk
- **Installer dependency** — 80% of installations require certified electrician/sweep
- **Customer acquisition cost** — "chimney fan" is not a category people search for spontaneously
- **B2B sales cycles** — housing associations and insurers have long, complex procurement
- **Small home market** — Denmark alone cannot sustain venture-scale growth

## Opportunities
- **EU air quality regulation** — EcoDesign directives create mandatory upgrade cycle
